...
/* loaded from: fqlite_next.jar:FxTextEditor.jar:goryachev/fx/FxTabPane.class */
public class FxTabPane extends TabPane {
    ...
    public Tab addTab(String name, final Supplier<Node> generator) {
        final Tab t = new Tab(name);
        ChangeListener<Boolean> li = new ChangeListener<Boolean>() { // from class: goryachev.fx.FxTabPane.1
            @Override // javafx.beans.value.ChangeListener
            public void changed(ObservableValue<? extends Boolean> src, Boolean old, Boolean val) {
                Node n = (Node) generator.get();
                t.setContent(n);
