...
/* loaded from: fqlite_next.jar:FxTextEditor.jar:goryachev/common/util/ClipPlayer.class */
public class ClipPlayer {
    ...
    public static void play(InputStream in) {
        try {
            ...
            clip.addLineListener(new LineListener() { // from class: goryachev.common.util.ClipPlayer.1
