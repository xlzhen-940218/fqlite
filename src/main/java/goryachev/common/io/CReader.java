...
/* loaded from: fqlite_next.jar:FxTextEditor.jar:goryachev/common/io/CReader.class */
public class CReader extends BufferedReader {
    ...
    public CReader(String text) {
        super(text == null ? new StringReader(ButtonBar.BUTTON_ORDER_NONE) : new StringReader(text));
    }
