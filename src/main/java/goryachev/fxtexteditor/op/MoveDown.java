...
/* loaded from: fqlite_next.jar:FxTextEditor.jar:goryachev/fxtexteditor/op/MoveDown.class */
public class MoveDown extends NavigationAction {
    protected static final Log log = Log.get("MoveDown");

    public MoveDown(FxTextEditor ed) {
        super(ed);
    }
