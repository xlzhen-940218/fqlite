...
/* loaded from: fqlite_next.jar:FxTextEditor.jar:goryachev/fxtexteditor/internal/TestComplexWrapInfo.class */
public class TestComplexWrapInfo {
    ...
    public void testTabIssue() {
        ...
        c2.set(wr.getCell(TextCell.globalInstance(), 0, 8));
        D.print(c1, c2);
    }

    @Test
    public void test() {
        test(4, 4, true, "123\t", new int[]{0, 1, 2, -4}, "456", new int[]{4, 5, 6});
    }

    @Test
    public void regression() {
        test(4, 4, true, "123\t", new int[]{0, 1, 2, -4}, "456", new int[]{4, 5, 6});
        test(8, 4, true, "\t1234", new int[]{-1, -1, -1, -1, 1, 2, 3, 4}, "56", new int[]{5, 6});
        test(4, 1, true, "1234", new int[]{0, 1, 2, 3});
        test(3, 1, true, "123", new int[]{0, 1, 2}, "4", new int[]{3});
    }
    ...
    protected void test(int width, int tabSize, boolean wrapLines, Object... args) {
        ...
        Object[] iArr = new Object[cells.size()];
        cells.toArray(iArr);
